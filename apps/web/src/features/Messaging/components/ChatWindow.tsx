...
export const ChatWindow: React.FC<ChatWindowProps> = ({ conversationId, currentUserId, onBack }) => {
    ...
    return (
        <div className="flex flex-col h-full bg-gray-50">
            {/* Header */}
            <div className="p-4 border-b border-white/20 glass-premium flex items-center gap-3 z-10">
                {onBack && (
            ...
            {/* Input Area */}
            <div className="p-4 glass-premium border-t border-white/20 z-10">
                <div className="flex gap-2">
                    ...
                    <button
                        ...
                        className={`w-10 h-10 rounded-full flex items-center justify-center transition-colors shrink-0 ${newMessage.trim()
