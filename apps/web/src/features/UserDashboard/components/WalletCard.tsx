...
export const WalletCard: React.FC<WalletCardProps> = ({ onTransactionComplete, refreshTrigger }) => {
    ...
    return (
        <div className="bg-linear-to-br from-gray-900 via-gray-800 to-black rounded-2xl shadow-2xl text-white p-8 relative overflow-hidden group transition-transform hover:scale-[1.01] duration-300">
