import { Transaction, PaymentMethod } from '@fiilar/types';
...
export const paymentService = {
    ...
    // Actions
    addFunds: async (amount: number, _paymentMethodId: string): Promise<Transaction> => {
        await delay(1500);
    ...
    processPayment: async (amount: number, method: 'WALLET' | 'CARD', _paymentMethodId?: string): Promise<Transaction> => {
        await delay(2000);
