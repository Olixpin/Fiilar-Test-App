...
const GlassSlider: React.FC<GlassSliderProps> = ({
    ...
    return (
        <div className={`relative ${className}`}>
            ...
            <div
                ref={sliderRef}
                className="relative w-full h-[10px] bg-gray-300 rounded-full cursor-pointer"
                onMouseDown={handleMouseDown}
                onTouchStart={handleTouchStart}
            >
                {/* Progress Bar */}
                <div
                    className="absolute h-full bg-gradient-to-r from-[#49a3fc] to-[#3681ee] rounded-full z-[1]"
                    style={{ width: `${percent}%` }}
                />
                ...
                <div
                    ...
                    className={`
                        ...
                        ${compact ? 'w-[45px] h-[32px]' : 'w-[65px] h-[42px]'} rounded-full cursor-pointer z-[2]
                ...
                >
                    ...
                    <div
                        ...
                        `}
                        style={{ filter: 'url(#mini-liquid-lens)' }}
                    />
