...
import { Booking, CancellationPolicy } from '../types';
...
export const calculateRefund = (
    ...
    return {
        ...
        canCancel,
        hoursUntilBooking: hoursUntil,
        reason: refundPercentage === 0 ? 'No refund available for this cancellation' : undefined
    };
};
...
export const processCancellation = async (
    ...
    try {
        ...
        if (refundAmount > 0) {
            await escrowService.refundToGuest(booking, refundAmount);
        }
