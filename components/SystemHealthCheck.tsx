...
import { createBooking, deleteBooking, getBookings, updateBooking, saveListing, deleteListing, getListings } from '../services/storage';
import { Booking, Listing, SpaceType, ListingStatus, BookingType, CancellationPolicy } from '../types';
    ...
    try {
      ...
      for (const date of dates) {
          ...
          const rBooking: Booking = {
              ...
              selectedAddOns: [],
              paymentStatus: 'Paid - Escrow',
              escrowReleaseDate: escrowService.calculateReleaseDate(date),
              transactionIds: []
          };
