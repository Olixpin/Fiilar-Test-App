...
const AdvancedSearch: React.FC<AdvancedSearchProps> = ({ filters, onFilterChange, onClose }) => {
    ...
    return (
        <div className={`bg-white border border-gray-200 transition-all duration-300 flex flex-col lg:sticky lg:top-[80px] self-start w-full hover:shadow-lg ${isExpanded ? 'lg:w-80 rounded-3xl' : 'lg:w-16 rounded-full'}`}>
